...
TextStyle w300_16Poppins({Color? color = Colors.black}) {
  return TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w300,
    color: color,
...
TextStyle w400_24Poppins({Color? color = Colors.black}) {
  return TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.w400,
    color: color,
...
TextStyle w500_12Poppins({
  Color? color = Colors.black,
  double errorTextHeight = 1,
}) {
  return TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.w500,
...
TextStyle w600_13Poppins({Color? color = Colors.black}) {
  return TextStyle(
    fontSize: 13,
    fontWeight: FontWeight.w600,
    color: color,
